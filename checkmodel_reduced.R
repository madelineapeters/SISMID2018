...
# Each sample of the four frequencies is based on one realisation (sample) 
# from the posterior distribution of the escape probability q. 
# The escape probability is assumed to be the same across all 334 households.
#
# This function outputs the mean of the predictive distribution of the four frequencies, 
# In addition, the joint predictive distribution of frequencies n1 and n11
# is plotted. 
#
...
# The number of MCMC samples of escape probability q 
mcmc.size = length(mcmc.sample$q)

# Discard the burn-in samples of q
